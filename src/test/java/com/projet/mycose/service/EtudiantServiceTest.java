...
public class EtudiantServiceTest {
    ...
    public void testGetStages_Success() {
        ...
        FormulaireOffreStage mockFormulaireOffreStage = new FormulaireOffreStage("unTitreForm", "uneEntreprise", "unEmployeur", "unEmail@mail.com", "unsite.com", "uneLocalisation", "1000", "uneDescription", createur, OffreStage.Visibility.PUBLIC, null, OffreStage.Status.ACCEPTED, OffreStage.SessionEcole.AUTOMNE, Year.of(2022), "09h00-17h00", "40");
    ...
    public void testGetStagesByRecherche_Success() {
        ...
        FormulaireOffreStage mockFormulaireOffreStage = new FormulaireOffreStage("Titre Form", "Entreprise A", "Employeur A", "emailA@mail.com", "siteA.com", "Localisation A", "1000", "Description A", createur, OffreStage.Visibility.PUBLIC, null, OffreStage.Status.ACCEPTED, OffreStage.SessionEcole.AUTOMNE, Year.of(2022), "09h00-17h00", "40");
