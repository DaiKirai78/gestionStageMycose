...
public class EnseignantService {
    ...
    public List<EtudiantDTO> getAllEtudiantsAEvaluerMilieuDeStage() {
        return ficheEvaluationMilieuStageRepository.findAllEtudiantsNonEvaluesMilieuDeStage().stream()
